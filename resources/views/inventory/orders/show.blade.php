...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if($order->isExternal() && $order->isPoIssued() && ! $order->isFulfilled())
            <div class="mt-4 bg-indigo-50 border border-indigo-200 text-indigo-900 px-4 py-3 rounded text-sm">
                <strong>LPO issued.</strong> Receive goods from <strong>Inventory → Receive Goods</strong> by selecting the LPO. Stock updates when each goods receive note is approved.
            </div>
        @endif
            ...
            <div class="mt-6 bg-white shadow sm:rounded-lg p-4 sm:p-6 border border-indigo-100">
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">Open an LPO to issue it to the supplier.</p>
                    </div>
