    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                ...
                <h2 class="mt-2 text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">
                    Create Payment Method and Maturation Period
                </h2>
            </div>
        </div>
        ...
        <div class="mt-8">
            <div class="bg-white shadow sm:rounded-lg">
                <form action="{{ route('maturation-periods.store') }}" method="POST" class="px-4 py-5 sm:p-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="maturation_days" id="maturation_days" 
                                   value="{{ old('maturation_days') }}" min="0" max="365" required
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3"
                                      ...
                                      placeholder="Optional description for this maturation period setting">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div id="account-section" style="display: none;">
                            <div class="border-t border-gray-200 pt-4 mt-4">
                                ...
                                <p class="text-sm text-gray-600 mb-4">A payment method account will be automatically created for this payment method. When clients pay, the system will debit this account and credit the client account.</p>
                                
                                <!-- Existing Account Display (if exists) -->
                                <div id="existing_account_display" style="display: none;" class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                                    <p class="text-sm font-medium text-gray-900 mb-1">Existing Account Found:</p>
                                    <p class="text-sm text-gray-700" id="existing_account_info"></p>
                                    <input type="hidden" name="payment_method_account_id" id="payment_method_account_id" value="">
                                </div>
...
document.getElementById('business_id').addEventListener('change', function() {
    ...
    const accountSelect = document.getElementById('payment_method_account_id');
