<div>
    <div class="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-xs text-gray-500 mt-0.5">SUOM in selected year</p>
        </div>
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-xs text-gray-500 mt-0.5">Distinct items in year</p>
        </div>
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <p class="text-xs text-gray-500 mt-0.5">Item × store × month</p>
        </div>
    </div>
